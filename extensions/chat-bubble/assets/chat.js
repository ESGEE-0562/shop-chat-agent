...
(function() {
  ...
  const ShopAIChat = {
    ...
    Message: {
      ...
      send: async function(chatInput, messagesContainer) {
        ...
        try {
          ...
          console.error('Error communicating with Barb:', error);
    ...
    Formatting: {
      ...
      formatMessageContent: function(element) {
        ...
        // Convert bare URLs to links (skip ones already inside href attributes)
    ...
    API: {
      ...
      streamResponse: async function(userMessage, conversationId, messagesContainer) {
        ...
        try {
          ...
          const streamUrl = 'https://shop-chat-agent-0dtd.onrender.com/chat';
      ...
      fetchChatHistory: async function(conversationId, messagesContainer) {
        try {
          ...
          const historyUrl = `https://shop-chat-agent-0dtd.onrender.com/chat?history=true&conversation_id=${encodeURIComponent(conversationId)}`;
    ...
    Auth: {
      ...
      startTokenPolling: function(conversationId, messagesContainer) {
        ...
        const poll = async () => {
          ...
          try {
            const tokenUrl = 'https://shop-chat-agent-0dtd.onrender.com/auth/token-status?conversation_id=' +
    ...
    /**
     * Quick reply pill buttons shown at the start of a new conversation
     */
    QuickReplies: {
      container: null,
    ...
    init: function() {
      ...
      if (conversationId) {
        ...
        // No previous conversation, show welcome message and quick replies
        const welcomeMessage = window.shopChatConfig?.welcomeMessage || "👋 Hi there! How can I help you today?";
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    // can drop a visitor straight into a conversation with Barb.
    const params = new URLSearchParams(window.location.search);
    if (params.get('barb') === 'open') {
      window.openBarbChat(params.get('barb_msg') || undefined);
    }
  });
})();
